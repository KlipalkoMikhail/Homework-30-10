...
int bit_test_sort(int number[], int k)                  // функция проверки отсортированного массива на упорядоченность ПО КОЛИЧЕСТВУ БИТОВ
{
    ...
    {
        int u1 = 0;                                                   // счетчик битов для первого числа
        int u2 = 0;                                                   // счетчик битов для второго числа
