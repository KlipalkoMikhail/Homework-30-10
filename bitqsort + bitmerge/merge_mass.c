...
void merge_mass(double C[], int l, int m, int r, int k)             // функция слияния двух массивов
{
    ...
    double A[array1];                                               // объявляем массив из первой половины чисел
    double B[array2];                                               // объявляем массив из второй половины чисел
    ...
    for(int s = l; s <= r; s++)                                     // цикл слияния двух массивов начинаем с левого указателя
    {
        ...
        else if (A[i] <= B[j])                                      // берем число из первого массива и сравниваем со вторым
        {
            C[s] = A[i];
            i++;
        }
